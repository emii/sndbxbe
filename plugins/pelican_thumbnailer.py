...
DEFAULT_GALLERY_THUMB = "thumbnail_wide"
...
class _resizer(object):
    ...
    def get_thumbnail_name(self, in_path):
        ...
        #basename = "{0}_{1}".format(basename, "thumbnail")
...
def resize_thumbnails(pelican):
    ...
    for dirpath, _, filenames in os.walk(in_path):
        out_path = path.join(pelican.settings['OUTPUT_PATH'],
                         pelican.settings.get('THUMBNAIL_DIR', DEFAULT_THUMBNAIL_DIR),path.split(dirpath)[1])
